...
Accomplished engineering leader with 15+ years of hands-on experience architecting scalable enterprise solutions and building high-performing engineering teams. Expert in platform modernization, distributed systems design, cloud-native architecture, and AI/LLM integration. Led technical delivery across Fortune 500 organizations while managing engineering teams, conducting 250+ technical interviews, and mentoring emerging leaders. Demonstrated ability to translate complex business challenges into elegant technical strategies with measurable impact: 80% deployment time reduction, 40% defect reduction, 85%+ code coverage. Ready for principal engineer, senior engineering manager, staff engineer, or chief software architect roles.
...
Key Accomplishments:
- Architected secure LLM integration layer enabling AI-assisted workflows into enterprise applications; reduced manual business process steps by 45%
- Led technical delivery of WebForms-to-.NET Core platform modernization initiative; reduced deployment frequency from weekly to daily with 80% reduction in deployment time
- Established SOLID principles and TDD practices across engineering teams; achieved 85%+ code coverage and reduced regression defects by 40%
- Designed multi-tenant warehouse management system supporting concurrent transactions for Fortune 500 logistics client; supported 10x transaction growth
- Implemented distributed caching strategy across microservices using Redis; reduced database load by 50% and improved API response times by 35%
- Conducted technical interviews across multiple disciplines; established hiring standards and technical assessment framework
- Mentored four engineers through architecture discussions, pair programming, and performance management; promoted two engineers to senior roles
- Led agile transformation as Scrum Master; improved team velocity by 25% and reduced sprint delivery variance

Technologies: .NET 8, ASP.NET Core, C#, Azure (Service Bus, Functions, Logic Apps), RabbitMQ, MassTransit, SQL Server, Redis, Docker, Kubernetes, OpenAI, GitHub Copilot
...
Key Accomplishments:
- Modernized Spotlight Excel Add-in from legacy VSTO to cloud-native architecture; improved reliability from 95% to 99.2% uptime and reduced support tickets by 35%
- Delivered Google Sheets Add-in POC and MVP in 45 days; established reusable architecture pattern for future add-in development; generated $2M revenue opportunity
- Architected and implemented event-driven notification system using Azure Service Bus; enabled real-time data synchronization across 50+ enterprise customers
- Optimized platform database queries; reduced query execution time by 55% and improved concurrent user capacity from 100 to 500 simultaneous users
- Established code review standards and mentored team on SOLID principles; improved code quality metrics by 40%
- Conducted campus hiring program; interviewed 50+ candidates and hired 8 engineers with 90% retention rate
- Recognized with technical excellence award for platform modernization leadership and quality contributions

Technologies: C#, .NET Framework, .NET Core, ASP.NET Core, VSTO, Azure (Logic Apps, Service Bus, Functions), SQL Server, Git, Azure DevOps
...
Key Accomplishments:
- Architected and delivered KTM (Kofax Transformation Module) document capture system processing 10M+ documents monthly; achieved 98% recognition accuracy
- Implemented query optimization and distributed caching reducing system processing time by 40%; supported 10x increase in document volume
- Designed and implemented event-sourcing pattern for audit trail; ensured compliance with regulatory requirements (SOX, HIPAA)
- Led Scrum ceremonies and delivery coordination; improved team velocity by 20% and reduced sprint delivery variance by 30%
- Established engineering standards for code quality, testing, and documentation across platform team
- Mentored junior engineers through pair programming and architectural discussions; promoted two engineers to senior roles
- Implemented CI/CD pipeline reducing manual deployment errors by 95%

Technologies: C#, .NET Framework, ASP.NET, WinForms, SQL Server, RabbitMQ, Event Sourcing, CQRS, Git
...
Key Accomplishments:
- Architected and developed Office Add-in suite (Outlook, Word, Excel) for enterprise messaging platform; shipped to 1000+ users
- Implemented OAuth and OIDC authentication patterns modernizing legacy ADFS systems; improved security posture and user experience
- Designed REST API for messaging platform supporting 10,000+ daily transactions; achieved 99.5% uptime SLA
- Led Active Directory synchronization agent development; automated user provisioning and reducing manual admin effort by 80%
- Established technical standards and mentored team on modern architecture patterns

Technologies: C#, .NET Framework, VSTO, WCF, WPF, OAuth, OIDC, ADFS, SQL Server, Git
...
Key Accomplishments:
- Developed embedded smart card reader firmware for Windows CE platform; shipped to 500+ fare gates across India
- Built FPR (Fare Processor Reader) desktop application for transaction processing; processed 100K+ daily transactions
- Implemented secure communication protocols for fare collection system ensuring PCI DSS compliance
- Established quality testing framework reducing production defects by 50%

Technologies: C++, MFC, Windows CE, C#, .NET Framework, SQL Server
...
- Established incident response processes reducing MTTR (Mean Time To Recovery) by 30%
...
Highly skilled engineering leader combining deep technical expertise with proven people leadership capabilities. Experienced in designing complex distributed systems, leading platform modernization initiatives, building and managing high-performing engineering teams, and establishing engineering excellence standards. Passionate about leveraging AI and modern development practices to accelerate delivery and improve quality. Ready to contribute as Principal Engineer, Senior Engineering Manager, Staff Engineer, Chief Software Architect, or Engineering Director.
